...
# File:	YaPIWriteZones.ycp
# Package:	Configuration of dns-server
# Summary:	Testsuite for writing zones for dns-server
  ...
  class YaPIWriteZonesClient < Client
    def main
        ...
        "sysconfig" => {
          ...
          "network"           => {
            "config" => {
              ...
              "NETCONFIG_DNS_STATIC_SERVERS"   => "5.5.5.5 6.6.6.6 7.7.7.7"
            }
          }
        },
        "target"    => {
      ...
      @zones = [
        {
          "options" => [
            { "value" => "master", "key" => "type" },
            { "value" => "\"example.com.zone\"", "key" => "file" }
          ],
          "zone"    => "example.com",
          "ttl"     => "1W",
          "records" => [
            { "value" => "127.0.0.1", "type" => "A", "key" => "host" },
            { "value" => "@", "type" => "NS", "key" => "example.com." }
          ],
          "file"    => "example.com",
          "type"    => "master",
          "soa"     => {
      ...
      DUMP("==========================================================")
      TEST(lambda { YaPI::DNSD.WriteZones({}, @zones) }, [@READ, @WRITE, @EXEC], nil)
      DUMP("==========================================================")
...
Yast::YaPIWriteZonesClient.new.main
